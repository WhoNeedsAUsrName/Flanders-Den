...
function preventclashes(){
  ...
  Remix.preventclash(['Warlock', 'The Warrior']);
}
...
function fillearlytwists(){
  ...
  if(player == 'Warrior') earlytwists.push('The Warrior'); //My version ot the warrior
...
function fillveryrare(){
  ...
  if(player != 'Warrior') veryrare.push('The Warrior'); //Warrior is offered Himself elsewhere
